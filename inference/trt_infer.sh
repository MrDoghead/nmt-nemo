...
enc_engine='./model_bin2/nmt_en_zh_transformer6x6_encoder_fp32.engine'
dec_init_engine='./model_bin2/nmt_en_zh_transformer6x6_decoder_init_fp32.engine'
dec_engine='./model_bin2/nmt_en_zh_transformer6x6_decoder_fp32.engine'
