...
class Serialization(ABC):
    ...
    def from_config_dict(cls, config: DictConfig):
        ...
        # dict_keys(['train_ds', 'validation_ds', 'test_ds', 'optim', 'encoder_tokenizer', 'decoder_tokenizer', 'encoder', 'decoder', 'head', 'beam_size', 'len_pen', 'max_generation_delta', 'label_smoothing', 'src_language', 'tgt_language', 'find_unused_parameters', 'num_val_examples', 'num_test_examples', 'target'])
